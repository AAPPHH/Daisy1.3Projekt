...
class Blocker(Player):
    ...
    def block_enemy(self, game, board, found_enemy, random_enemy_position):
        if found_enemy:
            if board.board[random_enemy_position[0] - 1][random_enemy_position[1]] == 0:
                return Player.place_piece(self, random_enemy_position[0] - 1, random_enemy_position[1], game, board)
            elif board.board[random_enemy_position[0] + 1][random_enemy_position[1]] == 0:
                return Player.place_piece(self, random_enemy_position[0] + 1, random_enemy_position[1], game, board)
            elif board.board[random_enemy_position[0]][random_enemy_position[1] - 1] == 0:
                return Player.place_piece(self, random_enemy_position[0], random_enemy_position[1] - 1, game, board)
            elif board.board[random_enemy_position[0]][random_enemy_position[1] + 1] == 0:
                return Player.place_piece(self, random_enemy_position[0], random_enemy_position[1] + 1, game, board)
            elif board.board[random_enemy_position[0] - 1][random_enemy_position[1] - 1] == 0:
                return Player.place_piece(self, random_enemy_position[0] - 1, random_enemy_position[1] - 1, game, board)
            elif board.board[random_enemy_position[0] - 1][random_enemy_position[1] + 1] == 0:
                return Player.place_piece(self, random_enemy_position[0] - 1, random_enemy_position[1] + 1, game, board)
            elif board.board[random_enemy_position[0] + 1][random_enemy_position[1] - 1] == 0:
                return Player.place_piece(self, random_enemy_position[0] + 1, random_enemy_position[1] - 1, game, board)
                ...
                return Player.place_piece(self, random_row, random_column, game, board)
        else:
            rdm_row = random.randint(0, self.m - 1)
            rdm_column = random.randint(0, self.n - 1)
            return Player.place_piece(self, rdm_row, rdm_column, game, board)
